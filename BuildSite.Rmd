...
replist=c("eff","p","a","m","Sept","Ex","Par","par","Pars","pars","July")
print(replist)
#paste0(replist,".")
...
rsadata$sourcenote=str_replace_all(rsadata$sourcenote,"pt\\.","Part")
rsadata$sourcenote=str_replace_all(rsadata$sourcenote,"part\\.","part")
#Const. art. 
...
law.dir="/run/media/kb/YellowThing/rsa.wiki/law/laws.md"
    ...
    if (length(t)>0){
      ...
      for (tn in 1:length(t)){
        ...
        if (isPL | isLaw){
          ...
          write(file=law.dir,nilnk(rsa$sectiontitle,rsa$mdlink),append = T)
        } else {
